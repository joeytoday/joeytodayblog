...
const html = () => "<p>It may be recommended to generate policies from <a href=\"https://policymaker.io\" rel=\"nofollow noopener noreferrer\" target=\"_blank\">PolicyMaker.io<span> ↗</span></a>.</p>";
				...
				const frontmatter = {"layout":"@/layouts/IndividualPage.astro","title":"Copyright","description":"Effective date: 2025-07-31","language":"ch-CN","back":"/terms/list","minutesRead":"1 min read","words":9};
