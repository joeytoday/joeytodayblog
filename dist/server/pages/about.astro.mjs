...
import { $ as $$Comment } from '../chunks/Comment_CIMhtcSk.mjs';
import { a as $$Spoiler, b as $$Collapse, c as $$Timeline } from '../chunks/Svg_D_ielPpo.mjs';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PageLayout", $$CommonPage, { "title": "About Me \u5173\u4E8E\u6211", "headings": headings, "info": "/about", "class": "astro-fwdcsva6" }, { "bottom": ($$result2) => renderTemplate`${renderComponent($$result2, "Comment", $$Comment, { "slot": "bottom", "class": "astro-fwdcsva6" })}`, "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<p class="astro-fwdcsva6">👏 Welcome to my blog! 欢迎来到我的博客～</p> <p style="line-height: 2;" class="astro-fwdcsva6">
相见即是缘分！欢迎来到这里。<br class="astro-fwdcsva6">
🧰 工具控，爱折腾。熟练掌握 <strong class="astro-fwdcsva6">Notion、Obsidian</strong> 等工具。
    喜欢很多美丽而“无用”的事物， <strong class="astro-fwdcsva6">📖 书籍 & 🎬 电影 & 🎵 音乐</strong>，
    希望在这个世界寻找一点乐趣，也<strong class="astro-fwdcsva6">「诚心祝福你，捱得到新天地」</strong>。<br class="astro-fwdcsva6">
如果你是新朋友，欢迎查看更多关于我的信息～欢迎扫描下方二维码关注我的公众号 👇
</p>  <div style="text-align: center; margin: 15px 0;" class="astro-fwdcsva6"> ${renderComponent($$result2, "Image", $$Image, { "src": mpQrCode, "width": "200", "alt": "\u516C\u4F17\u53F7\u4E8C\u7EF4\u7801", "class": "mx-auto max-w-[80vw] astro-fwdcsva6", "loading": "lazy" })} </div> <p class="astro-fwdcsva6">
如果有更多想说的，也可以 📮 <a href="mailto:joeytoday247@outmail.com" class="astro-fwdcsva6">给我发邮件</a> ${renderComponent($$result2, "Spoiler", $$Spoiler, { "class": "astro-fwdcsva6" }, { "default": ($$result3) => renderTemplate` 🎉 这里是彩蛋内容：祝你今日开心！` })} </p> <div class="media-player-container astro-fwdcsva6"> <p class="astro-fwdcsva6">🎵 接下来可以听着音乐继续看：</p> <div style="
      width: 100%; 
      max-width: 700px; 
      margin: 15px auto 0; 
      padding: 0;
      ...
      position: relative;
      min-width: 280px;
    " class="astro-fwdcsva6"> <!-- 网易云歌单iframe --> <div class="astro-fwdcsva6"> <iframe src="https://music.163.com/outchain/player?type=0&id=13382956851&auto=0&height=280" style="
            ...
            min-height: 260px;
            pointer-events: auto;
          " frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="false" loading="lazy" title="我的音乐清单" sandbox="allow-scripts allow-same-origin allow-popups allow-pointer-lock" scrolling="no" class="astro-fwdcsva6"></iframe> </div> <!-- 加载状态提示 --> <div id="musicLoader" style="
        position: absolute; 
        top: 0; 
        left: 0; 
        right: 0; 
      ...
      " class="astro-fwdcsva6">
音乐清单加载中...</div> <!-- 手机端提示（移动端会随播放器一起隐藏，无需额外处理） --> <p style="
        text-align: center; 
        font-size: 12px; 
        color: #888; 
        margin: 8px 0 0;
...
点击播放按钮，可切换歌单内歌曲 🎵
    ...
    包含多重加载检测机制和超时处理
    --> ${renderScript($$result2, "/Users/kaiyijing/GitHub/joeytodayblog/src/pages/about/index.astro?astro&type=script&index=0&lang.ts")} </div> <h2 id="hobbies" class="astro-fwdcsva6">Hobbies 我的爱好</h2> <ul class="astro-fwdcsva6"> <li class="astro-fwdcsva6">📖 喜欢阅读与电影，经常写随笔，也经常放鸽子。看不到我的随笔，也欢迎看看👉<a href="https://note.joeytoday.com/" class="astro-fwdcsva6">📒 我的笔记</a></li> <li class="astro-fwdcsva6">✈️ 喜欢宅家，但也爱旅行，若有喜爱的朋友相伴，是美事一桩～</li> <li class="astro-fwdcsva6">🎈 日常 J 人，出门就变 P，主打一个什么都行，开心就好!</li> <li class="astro-fwdcsva6">🎵 很爱音乐，只要好听！这里是我的推荐，如果你也想听听看～👉<a href="https://joeytoday.notion.site/music" class="astro-fwdcsva6">joeytoday的歌单</a></li> <li class="astro-fwdcsva6">🐈 家有傲娇小猫，名曰「兜兜」，不粘人但喜欢人，喜欢被拍拍，但最喜欢我（我自封），附上兜兜美照。</li> </ul> <div style="text-align: center; margin: 15px 0; padding: 0 10px;" class="astro-fwdcsva6"> ${renderComponent($$result2, "Image", $$Image, { "src": doudou, "width": "700", "alt": "\u5C0F\u732B\u515C\u515C", "class": "mx-auto max-w-full astro-fwdcsva6", "loading": "lazy", "style": "border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" })} </div> ${renderComponent($$result2, "BooksDisplay", $$BooksDisplay, { "class": "astro-fwdcsva6" })} <h2 id="tools" class="astro-fwdcsva6">Tools 我的工具</h2> <p class="astro-fwdcsva6">Current support tools as follow:</p> ${renderComponent($$result2, "ToolSection", $$ToolSection, { "class": "mb-5 astro-fwdcsva6", "title": "Productivity", "tools": [
    {
      name: "Notion",
  ...
  ] })} ${renderComponent($$result2, "ToolSection", $$ToolSection, { "class": "mb-5 astro-fwdcsva6", "title": "Device", "tools": [
    {
  ...
  ] })} <h2 id="social-networks" class="astro-fwdcsva6">Social Networks 社交媒体</h2> <p class="astro-fwdcsva6">
👏 欢迎关注～有什么想说的，也可以 💬 <a href="https://www.notion.so/joeytoday/310f5493daf44d82a0599d2c034100cb" class="astro-fwdcsva6">给我留言</a> </p> ${renderComponent($$result2, "FriendList", $$FriendList, { "list": friends[3], "class": "astro-fwdcsva6" })} <h2 id="gossips" class="astro-fwdcsva6">Gossips 碎碎念</h2> ${renderComponent($$result2, "Collapse", $$Collapse, { "title": "\u788E\u788E\u5FF5", "class": "astro-fwdcsva6" }, { "default": ($$result3) => renderTemplate`
其实这里的文字只是为了凑这个模块，嘿嘿，看来你打开了这里 😊
` })} <h2 id="about-blog" class="astro-fwdcsva6">About Blog 关于此博客</h2> <p class="astro-fwdcsva6">
本站出于我一时的热情建立，熬了两个通宵终于初步完成了，希望能成为我记录生活的开始。<br class="astro-fwdcsva6">
有点类似千禧年代的互联网精神，开源的、互联的，现在想来有点浪漫～<br class="astro-fwdcsva6">
搭建有点辛苦，但过程很开心，希望各位网友也阅读开心！🎉 撒花
</p> ${renderComponent($$result2, "Collapse", $$Collapse, { "title": "Website history", "class": "astro-fwdcsva6" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Timeline", $$Timeline, { "events": linksConf.logbook, "class": "astro-fwdcsva6" })} ` })}   ` })}`;
