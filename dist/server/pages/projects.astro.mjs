/* empty css                                 */
import { d as createAstro, c as createComponent, m as maybeRenderHead, b as addAttribute, s as spreadAttributes, r as renderComponent, a as renderTemplate, g as defineScriptVars } from '../chunks/astro/server_CTfvycMK.mjs';
import 'kleur/colors';
import '../chunks/index_MaT6fT73.mjs';
import { $ as $$Image } from '../chunks/_astro_assets_1m3gVEp1.mjs';
import { d as $$Icon, $ as $$Button } from '../chunks/Svg_BVt06kNw.mjs';
import { $ as $$CommonPage } from '../chunks/CommonPage_CLnuBBHv.mjs';
import { c as cn } from '../chunks/class-merge_ZZ4CtDft.mjs';
/* empty css                                 */
import { c as config } from '../chunks/BaseLayout_CiqShqGj.mjs';
...
👇 这里是我的项目合集，如果你觉得有意思 or 对你有用的话，欢迎给作者买杯咖啡☕️～
</p> ${renderComponent($$result2, "Button", $$Button, { "title": "Checkout sponsorship", "class": "w-fit astro-2hwget37", "href": "#sponsorship" }, { "before": async ($$result3) => renderTemplate`${renderComponent($$result3, "Icon", $$Icon, { "class": "size-5 astro-2hwget37", "name": "receive-money", "slot": "before" })}` })} <h2 id="notion-temp" class="astro-2hwget37">Notion 模板</h2> ${renderComponent($$result2, "ProjectSection", $$ProjectSection, { "projects": [
    {
      ...
      links: [
        ...
        { type: "link", href: "https://www.xiaohongshu.com/discovery/item/68a572a4000000001d01dd67?xsec_token=ABR7z7ngc0MAcw1sqpm1SJwIFfeFu8Kulw2Aqx72uX938" },
    ...
    },
    {
      ...
      links: [
        //{ type: 'github', href: 'https://github.com/cworld1/astro-theme-pure' },
        { type: "link", href: "https://www.xiaohongshu.com/discovery/item/686f48920000000017037b46?xsec_token=ABGSWRQXZpuOdav7ypGfUUzNZG66S9LPP37YNz4iyd0xM" },
    ...
    },
    {
      ...
      links: [
        //{ type: 'github', href: 'https://github.com/cworld1/astro-theme-pure' },
        { type: "link", href: "https://www.xiaohongshu.com/discovery/item/687eebe80000000013012264?xsec_token=ABXasX90R282Rybry8UfkAsGW8ZbbXyMWXIfbM3xtqOd0" },
    ...
    },
    {
      ...
      links: [
        //{ type: 'github', href: 'https://github.com/cworld1/astro-theme-pure' },
        { type: "link", href: "https://www.xiaohongshu.com/discovery/item/689584ef00000000020017de?xsec_token=ABY_OeELXbiWFQQgYftHsYt0HWQm9ZJx8RG-aR1QCx3T0" },
