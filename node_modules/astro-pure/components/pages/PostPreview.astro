...
const { as: Tag = 'div', post, detailed = false, simple = false, class: className } = Astro.props
...
<li
  class={cn(
    ...
    detailed || simple && 'max-sm:px-4 sm:py-5',
    className
  )}
  style={detailed &&
...
>
  ...
  >
    ...
    {/* 日期｜阅读时间*/}
    <div class='flex items-center gap-2 py-1 text-sm mb-2 text-muted-foreground'>
    ...
    <Tag class='z-10 flex-grow text-lg'>

      {/* title */}
      <div class='flex justify-between mb-1'>
        <div class={detailed || simple && 'font-medium'}>
      ...
      {simple && (
        <>
          ...
          {data.description && (
            <p
              class={cn(
                'line-clamp-2 leading-relaxed pt-1 text-base mb-1 text-muted-foreground sm:line-clamp-3'
              )}
            >
              {data.description}
            </p>
...

      {
        detailed && (
          <>
            ...
            <p
              class={cn(
                'line-clamp-2 leading-relaxed pt-1 text-base mb-2 text-muted-foreground sm:line-clamp-3',
